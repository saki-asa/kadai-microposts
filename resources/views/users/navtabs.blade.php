<ul class="nav nav-tabs nav-justified mb-3">
    ...
    <li class="nav-item"><a href="{{ route('users.followers', ['id' => $user->id]) }}" class="cav-link {{ Request::is('users/*/followers') ? 'active' : '' }}">Followers <span class="badge badge-secndary">{{ $count_followers }}</span></a></li>
</ul>